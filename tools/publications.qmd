...
i1 <- (tab$Status == "s" & tab$Type != "Book chapters")
...
i2 <- ((tab$Status %in% c("s", "ta")) == FALSE & is.na(tab$Volume) == FALSE & tab$Type != "Book chapters")
tab1[i2] <- paste(tab1, ", **", tab$Issue, "**(", tab$Volume, "), ", tab$Pages, ". ", sep = "")[i2]

# papers with reference and no volume
i2b <- ((tab$Status %in% c("s", "ta")) == FALSE & is.na(tab$Volume) == TRUE & tab$Type != "Book chapters")
tab1[i2b] <- paste(tab1, ", **", tab$Issue, "**:", tab$Pages, ". ", sep = "")[i2b]

# book chapters
i2c <- (tab$Type == "Book chapters")
tab1[i2c] <- paste(tab$First, " (**", tab$Year, "**). ", tab$Title, ". ", tab$Journal, ", ", tab$Pages, ". ", sep = "")[i2c]
...
# quarto
i5 <- (is.na(tab$quarto) == FALSE)
tab1[i5] <- paste(tab1, " [quarto](", tab$quarto, ") | ", sep = "")[i5]
