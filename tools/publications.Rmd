...
# papers with reference
i2 <- ((tab$Status %in% c("s", "ta")) == FALSE)
tab1[i2] <- paste(tab1, ", **", tab$Issue, "**(", tab$Issue, "), ", tab$Pages, ". ", sep = "")[i2]
...
tab1[i4] <- paste(tab1, " [arxiv](", tab$arxiv, ") ", sep = "")[i4]
...
tab1[i7] <- paste(tab1, " [cran](", tab$cran, ") ", sep = "")[i7]
