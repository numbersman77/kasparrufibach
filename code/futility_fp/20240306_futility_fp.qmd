---
title: "False-positive risk when adding a futility interim analysis to a clinical trial"
...
segments(0, 1, inter_x[1], resHR[, 1], col = grey(0.9), lty = 1)
...
segments(0, 1, inter_x[1], resHR[ind, 1], col = 3, lty = 1)
